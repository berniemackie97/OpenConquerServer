...
namespace OpenConquer.Infrastructure.Persistence.Schema;

internal sealed class SchemaCompatibilityConfiguration : IEntityTypeConfiguration<SchemaCompatibilityRecord>
{
