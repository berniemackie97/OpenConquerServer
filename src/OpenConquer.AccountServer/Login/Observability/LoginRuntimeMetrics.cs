...
internal sealed class LoginRuntimeMetrics
{
    ...
    private readonly Counter<long> _sourceRejections;
    ...
    public LoginRuntimeMetrics(IMeterFactory meterFactory)
    {
        ...
        _sourceRejections = meter.CreateCounter<long>("openconquer.account_server.login.admission.source_rejections", "{connection}", "Connections rejected because the per-source concurrent login connection limit was reached.");
    ...
    public void RecordSourceRejection() => _sourceRejections.Add(1);
